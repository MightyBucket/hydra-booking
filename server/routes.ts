...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Recurring lesson routes
  app.get("/api/recurring-lessons", async (req, res) => {
    try {
  ...
  app.get("/api/recurring-lessons/:id", async (req, res) => {
    try {
  ...
  app.post("/api/recurring-lessons", async (req, res) => {
    try {
  ...
  app.put("/api/recurring-lessons/:id", async (req, res) => {
    try {
  ...
  app.delete("/api/recurring-lessons/:id", async (req, res) => {
    try {
